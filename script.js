const city = 1204;
const date = new Date();
const dd = String(date.getDate()).padStart(2, "0"); //padstart itu buat didepan angka ada angka 0 jika digit kurang dari batas yang kita tentukan.
const mm = String(date.getMonth() + 1).padStart(2, "0");
const yyyy = date.getFullYear();

console.log(mm);

const now = yyyy + "_" + mm + "_" + dd;
